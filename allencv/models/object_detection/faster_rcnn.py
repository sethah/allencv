...
class PretrainedDetectronFasterRCNN(RCNN):
    ...
    def __init__(self,
        ...
        box_roi_head = FasterRCNNROIHead(vocab,
                                         encoder,
                                         pooler_resolution=7,
        ...
        box_roi_head.cls_score.load_state_dict(frcnn.roi_heads.box_predictor.cls_score.state_dict())
        box_roi_head.bbox_pred.load_state_dict(frcnn.roi_heads.box_predictor.bbox_pred.state_dict())
